...
def create_student
  ...
  _parent_permission = gets.chomp.capitalize
  case parent_permission
  when 'Y'
    _parent_permission = true
  when 'N'
    _parent_permission = false
  else
    puts 'Please enter valid command'
  end

  student = Student.new(age, name, _parent_permission: true)
  @person.push(student)
...
def create_teacher
  ...
  teacher = Teacher.new(specialization, age, name, _parent_permission: true)
  @person.push(teacher)
  puts 'Person created Successfully'
end
